  ...
  <div id="content">
    ...
    <form action="insert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" name="form2" id="form2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="28"><div align="left">First Name:</div></td>
        ...
        <tr>
          <td height="28"><div align="left">Last Name:</div></td>
        ...
        <tr>
          <td height="37"><div align="left">Collage:</div></td>
          <td><label>
		...
		<tr>
          <td height="28"><div align="left">Building name :</div></td>
          <td><span id="sprytextarea1">
            <label>
		...
		<tr>
          <td height="28"><div align="left">Office No:</div></td>
        ...
        <tr>
          <td height="29">Registration Date:</td>
        ...
        <tr>
          ...
          <td><label>
          	 <input type="image" name="button2" src="Button/reg.png" value="Submit" />
          </label></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
    ...
    <table width="100%" border="0" cellspacing="3" cellpadding="3">
      ...
      <tr>
        <td><p><img src="img/shorba.jpg" alt="box" width="100" height="100" hspace="10" align="left" class="imgleft" title="box" /></p></td>
      ...
      <tr>
        <td height="26" bgcolor="#BCE0A8"><div align="center" class="style9">Shoriba</div></td>
        <td bgcolor="#BCE0A8"><div align="center" class="style9">Dorowet</div></td>
        <td bgcolor="#BCE0A8"><div align="center" class="style9">burger</div></td>
      </tr>
    </table>
  </div>
  <?php
